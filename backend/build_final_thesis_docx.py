...
def build_thesis_docx():
    ...
    add_num_item("5.", "", "Implement a dual-layer confidence score thresholding mechanism (tau = 0.50) to trigger low-confidence fallback responses and create real-time human escalation tickets.")
    ...
    add_bullet("Conversational Logs & Escalations Viewer:", "Displays active customer chat history across sessions and flags inquiries escalated to human representatives.")
    ...
    add_num_item("4.", "Reliable Handling of Edge Cases and Escalations", "The system exhibited high reliability in identifying out-of-domain inquiries and explicit customer handoff requests, achieving a 100.00% human-escalation correctness rate in automated benchmarking.")
    ...
    add_bullet("Customer interactions across web chat and WhatsApp can be automated securely", "while preserving human oversight through automated escalation handoffs.")
