    ...
    <div className="max-w-2xl mx-auto flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-5">
        ...
        <div className="flex flex-col">
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white">Create Business Profile</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Register a new Ghanaian SME context model.</p>
        </div>
      </div>
