...
export default function EditProduct({ params }: { params: any }) {
  ...
  const getProductCategoryText = () => {
    if (!activeBusiness) return {
      title: "Edit Product",
      subtitle: "Modify properties of product item.",
    ...
    if (category.includes("education") || category.includes("school") || category.includes("academy")) {
      return {
        title: "Edit School Item / Fee",
        subtitle: "Modify properties of school item.",
      ...
      return {
        ...
        subtitle: "Modify properties of menu item.",
      ...
      return {
        title: "Edit Drug / Medicine",
        subtitle: "Modify properties of drug item.",
