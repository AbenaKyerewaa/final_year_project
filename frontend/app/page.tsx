...
> = {
  electronics: {
    businessName: "Michy Tech Hub",
    description: "Computer Sales & Repair in Madina, Accra",
    questions: [
      {
      ...
      },
      {
        ...
        a: "We accept **Mobile Money, Cash or Bank Transfer**.",
      },
      {
        q: "Do you deliver to Accra?",
        a: "Yes, we deliver nationwide. We deliver within Accra via dispatch riders and nationwide via VIP Bus or OA Travel.",
      },
    ],
    initialMessages: [
      ...
      {
        sender: "ai",
        text: "Yes, we are! Michy Tech Hub is open Monday - Saturday from 8:30 AM to 7:30 PM. How can I help you today?",
      },
    ],
  },
  pharmacy: {
...
export default function Home() {
  ...
  const formatMsgText = (text: string, sender: "customer" | "ai") => {
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 font-sans select-none scroll-smooth transition-colors duration-300">
      ...
      {!loadingHealth && (!health || health.status === "disconnected") && (
        <div className="w-full bg-rose-950/40 border-b border-rose-900/40 py-2.5 px-4 text-center text-xs text-rose-300 backdrop-blur-md sticky top-0 z-50 transition-all duration-300">
          <span className="inline-flex items-center gap-1.5 font-medium">
            ...
            <svg className="w-4 h-4 text-rose-500 shrink-0 inline-block align-middle" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
      ...
      <header className="sticky top-0 z-40 w-full flex justify-center py-4 px-4 sm:px-6">
        <div className="w-full max-w-6xl glass-panel rounded-2xl py-3 px-6 flex items-center justify-between shadow-lg shadow-black/10 dark:shadow-black/35 backdrop-blur-md">
          {/* Logo & Badge */}
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col text-left">
              <span className="text-md font-bold tracking-tight bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700 dark:from-white dark:via-slate-100 dark:to-slate-300 bg-clip-text text-transparent">
                EasyBiz AI
              </span>
              <span className="text-[9px] font-medium tracking-widest text-indigo-600 dark:text-indigo-400 uppercase leading-none">
                SME Automation
              </span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-7 text-xs font-semibold text-slate-500 dark:text-slate-400">
            <a href="#features" className="hover:text-slate-800 dark:hover:text-slate-100 transition-colors">
              Features
            </a>
            <a href="#use-cases" className="hover:text-slate-800 dark:hover:text-slate-100 transition-colors">
              Use Cases
            </a>
            <a href="#contact" className="hover:text-slate-800 dark:hover:text-slate-100 transition-colors">
              Contact
            </a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-100/50 dark:bg-slate-900/40 text-slate-700 dark:text-slate-350 hover:bg-slate-200 dark:hover:bg-slate-800 transition duration-200 active:scale-95"
              title="Toggle Theme"
            >
            ...
            {user ? (
              <div className="flex items-center gap-2">
                <Link
                  href="/dashboard"
                  className="px-3.5 py-1.5 rounded-lg text-xs font-semibold bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-350 border border-indigo-200 dark:border-indigo-900/40 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 hover:text-indigo-700 dark:hover:text-indigo-200 transition-all duration-300"
                >
                  Dashboard
                </Link>
                <button
                  onClick={logout}
                  className="px-3.5 py-1.5 rounded-lg text-xs font-semibold border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/30 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-900/80 transition-all duration-300"
                >
                  Logout
                </button>
              </div>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2.5">
                <Link
                  href="/login"
                  className="px-3 py-1.5 text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white transition-colors"
                >
                  Log In
                </Link>
                <Link
      ...
      <section className="relative w-full min-h-[92vh] flex items-center justify-center overflow-hidden py-12 md:py-20">
        ...
        <div className="relative z-20 w-full max-w-6xl px-4 sm:px-6 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 flex flex-col gap-6 text-center lg:text-left max-w-2xl">
            ...
            <div className="self-center lg:self-start inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-semibold tracking-wider bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900/40 uppercase">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4 justify-center lg:justify-start">
              ...
              <a
                href="#use-cases"
                className="px-6 py-3.5 rounded-xl font-semibold text-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/30 text-slate-700 dark:text-slate-350 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-900/80 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 text-center"
              >
                Interactive Demo
              </a>
            </div>
            ...
            {/* Quick Metrics Grid */}
            <div className="grid grid-cols-3 gap-4 pt-6 mt-4 border-t border-slate-200 dark:border-slate-900/80 text-left">
              <div>
                <span className="block text-2xl font-extrabold text-slate-900 dark:text-white">99.8%</span>
                <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-500">
                  RAG Accuracy
                </span>
              </div>
              <div>
                <span className="block text-2xl font-extrabold text-slate-900 dark:text-white">24/7</span>
                <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-500">
                  Active Support
                </span>
              </div>
              <div>
                <span className="block text-2xl font-extrabold text-slate-900 dark:text-white">0 lines</span>
                <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-500">
                  Code Needed
                </span>
              </div>
          ...
          <div className="w-full max-w-[420px] glass-panel-heavy rounded-[40px] p-6 shadow-2xl relative border border-slate-200 dark:border-white/10 glow-indigo flex flex-col min-h-[460px] max-h-[500px]">
            {/* Notch */}
            ...
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800/80 pb-4 pt-2">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-bold text-xs uppercase shadow-sm">
                    {SIMULATED_CONVERSATIONS[activeSector].businessName.charAt(0)}
                  </div>
                  <span className="absolute bottom-0 right-0 w-3 h-3 rounded-full bg-emerald-500 border-2 border-white dark:border-slate-950"></span>
                </div>
                <div className="flex flex-col text-left">
              ...
              <div className="flex items-center gap-1 bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-2 py-0.5 rounded-full text-[9px] font-semibold">
            ...
            <div className="flex gap-1.5 my-3 overflow-x-auto pb-1.5 scrollbar-none border-b border-slate-200 dark:border-slate-900/60">
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[10px] font-semibold capitalize whitespace-nowrap border shrink-0 transition-all duration-300 ${
                    activeSector === sect
                      ...
                      : "bg-slate-100 dark:bg-slate-900/50 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-800 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-800"
                  }`}
            ...
            <div className="flex-1 flex flex-col gap-3.5 my-2 text-xs text-left overflow-y-auto pr-1 select-text scrollbar-thin">
                  ...
                  <div
                    className={`p-3 rounded-2xl leading-relaxed ${
                      msg.sender === "customer"
                        ...
                        : "rounded-tl-none bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200"
                    }`}
                  >
                    {formatMsgText(msg.text, msg.sender)}
                  </div>
                </div>
              ))}
              ...
              {typingState === "customer" && (
                <div className="flex flex-col gap-1 max-w-[85%] self-end items-end">
                  <span className="text-[9px] text-slate-500 dark:text-slate-400">Customer</span>
              ...
              {typingState === "ai" && (
                <div className="flex flex-col gap-1 max-w-[85%] self-start items-start">
                  <span className="text-[9px] text-slate-500 dark:text-slate-400">AI Assistant</span>
                  <div className="p-3 rounded-2xl rounded-tl-none bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 flex items-center gap-1 w-12 justify-center">
            ...
            <div className="border-t border-slate-200 dark:border-slate-800/80 pt-3">
              <span className="block text-[9px] text-left uppercase font-bold tracking-wider text-slate-500 dark:text-slate-400 mb-2">
                Ask the Assistant:
              </span>
              <div className="flex flex-col gap-1.5">
                {SIMULATED_CONVERSATIONS[activeSector].questions.map((q, idx) => (
                  <button
                    ...
                    disabled={typingState !== "none"}
                    className="w-full text-left p-2 rounded-xl text-[10px] bg-slate-100/50 dark:bg-slate-900/40 hover:bg-slate-200 dark:hover:bg-slate-900 border border-slate-200 dark:border-slate-800/60 hover:border-slate-300 dark:hover:border-slate-700/85 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed leading-snug truncate"
                  >
                    <span className="inline-flex items-center gap-1.5 w-full">
                      <svg className="w-3.5 h-3.5 text-indigo-500 dark:text-indigo-400 shrink-0 inline-block align-middle" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <section id="features" className="w-full py-20 px-4 sm:px-6 flex flex-col items-center border-t border-slate-200 dark:border-slate-900/60 bg-gradient-to-b from-white via-slate-50 to-white dark:from-slate-950 dark:via-slate-950 dark:to-slate-900/40 transition-colors duration-300">
        <div className="w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 glass-card-hover md:col-span-1">
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Multi-Business Profiles</h3>
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 glass-card-hover md:col-span-2">
              <div className="flex justify-between items-start">
                ...
                <span className="px-2 py-0.5 rounded text-[8px] font-semibold tracking-wider bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-900/30 uppercase">
                  Simulation Included
                </span>
              </div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Official WhatsApp Cloud Integration</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 glass-card-hover md:col-span-2">
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Dynamic RAG Indexing</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 glass-card-hover md:col-span-1">
              <div className="w-10 h-10 rounded-xl bg-indigo-500/10 border border-indigo-500/25 flex items-center justify-center text-indigo-600 dark:text-indigo-400">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                </svg>
              </div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Inventory Catalog</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 glass-card-hover">
              <div className="w-10 h-10 rounded-xl bg-cyan-500/10 border border-cyan-500/25 flex items-center justify-center text-cyan-600 dark:text-cyan-400">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Offline Local AI</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 glass-card-hover">
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Audio & Voice Transcripts</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 glass-card-hover">
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Escalation Hand-off</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      <section id="use-cases" className="w-full py-20 px-4 sm:px-6 flex flex-col items-center bg-gradient-to-b from-white via-white to-slate-50 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900/30 border-t border-slate-200 dark:border-slate-900/60 transition-colors duration-300">
        <div className="w-full max-w-6xl">
          {/* Header */}
          <div className="text-center max-w-xl mx-auto mb-16 flex flex-col gap-4">
            <span className="text-xs font-semibold tracking-widest text-indigo-600 dark:text-indigo-400 uppercase">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-1 glass-panel rounded-2xl p-4 flex flex-col gap-2">
              <button
                ...
                className={`w-full text-left p-4 rounded-xl border flex items-center gap-3.5 transition-all duration-300 ${
                  activeSector === "electronics"
                    ? "bg-indigo-50 dark:bg-indigo-950/40 border-indigo-500/80 text-indigo-900 dark:text-white"
                    : "bg-slate-50 dark:bg-slate-900/30 border-slate-200 dark:border-slate-800/80 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900/50"
                }`}
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 leading-none">Catalog, prices, warranties</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 leading-none">Catalog & Medical disclaimers</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 leading-none">Menu, pricing, delivery ranges</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 leading-none">Admissions, school fees list</span>
                </div>
              </button>
            </div>
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="glass-panel rounded-2xl p-6 border-slate-200 dark:border-white/10 shadow-lg text-left">
                <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4 mb-4">
                  <div className="flex items-center gap-2">
                    <span className="text-xs px-2 py-0.5 rounded bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 font-mono uppercase text-[9px] border border-indigo-200 dark:border-indigo-900/30">
                      SME Portal View
                    </span>
                    <span className="text-xs font-bold text-slate-800 dark:text-white">Database Seed Dashboard Preview</span>
                  </div>
                  <span className="text-[10px] text-slate-500 dark:text-slate-400">Auto-Indexed to Vector Store</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-3">
                    <div>
                      ...
                      <div className="mt-1 text-xs text-slate-700 dark:text-slate-300 bg-slate-100/50 dark:bg-slate-950/60 p-3 rounded-xl border border-slate-200 dark:border-slate-900/80 leading-relaxed font-mono">
                        <span className="text-slate-500 dark:text-slate-400">Name:</span> {SIMULATED_CONVERSATIONS[activeSector].businessName}
                        <br />
                        <span className="text-slate-500 dark:text-slate-400">Category:</span> {activeSector === "electronics" ? "Computer Sales & Repair" : activeSector === "pharmacy" ? "Pharmacy" : activeSector === "restaurant" ? "Food & Beverage" : "Education & School"}
                        <br />
                        <span className="text-slate-500 dark:text-slate-400">Location:</span> {activeSector === "electronics" ? "Madina, Accra" : activeSector === "pharmacy" ? "Accra, Ghana" : activeSector === "restaurant" ? "Osu, Accra" : "East Legon, Accra"}
                        <br />
                        <span className="text-slate-500 dark:text-slate-400">Payments:</span> {activeSector === "electronics" ? "Mobile Money, Cash, Bank Transfer" : activeSector === "pharmacy" ? "Mobile Money, Cash, Bank Transfer" : activeSector === "restaurant" ? "Cash, MoMo, Visa/Mastercard" : "Bank Draft, MoMo, School Pay"}
                      </div>
                    </div>
                    ...
                    {activeSector === "pharmacy" && (
                      <div>
                        ...
                        <div className="mt-1 text-[11px] text-rose-700 dark:text-rose-350 bg-rose-50 dark:bg-rose-950/15 p-3 rounded-xl border border-rose-200 dark:border-rose-900/20 leading-relaxed flex items-start gap-1.5">
                          <svg className="w-3.5 h-3.5 text-rose-600 dark:text-rose-500 shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                          </svg>
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-xs text-slate-700 dark:text-slate-350 bg-slate-100/50 dark:bg-slate-950/60 p-3 rounded-xl border border-slate-200 dark:border-slate-900/80 font-mono max-h-[170px] overflow-y-auto leading-relaxed">
                      {activeSector === "electronics" && (
                        <div>
                          - HP EliteBook 840 G6 (GHS 4,200) [In Stock]
                          <br />
                          - Dell Latitude 5400 (GHS 5,900) [In Stock]
                          <br />
                          - Universal Charger (GHS 150) [15 Units]
                          <br />
                          - FAQ: "Do you deliver?" -&gt; "Yes, we ship Nationwide via VIP Bus or OA Travel."
                        </div>
                      )}
                      {activeSector === "pharmacy" && (
                        <div>
                      ...
                      {activeSector === "restaurant" && (
                        <div>
                          - Jollof Rice + Chicken (GHS 65.00)
                          <br />
                          - Fufu + Light Soup (GHS 80.00)
                          <br />
                          - Kelewele (GHS 25.00)
                          <br />
                          - FAQ: "Do you deliver?" -&gt; "Flat GHS 25 within selected locations in Accra."
                        </div>
                      )}
                      {activeSector === "school" && (
                        <div>
                          - Tuition (Primary): GHS 2,500 per term
                          <br />
                          - Uniforms: GHS 250 per set
                          <br />
                          - FAQ: "Application fee?" -&gt; "GHS 150 at East Legon office."
                        </div>
                      )}
                    </div>
                  </div>
              ...
              <div className="glass-panel-light rounded-2xl p-5 border-slate-200/50 dark:border-white/5 text-left text-xs text-indigo-700 dark:text-indigo-300 flex flex-col gap-2 bg-indigo-50/50 dark:bg-indigo-950/30">
      ...
      {/* Contact Section */}
      <section id="contact" className="w-full py-20 px-4 sm:px-6 flex flex-col items-center bg-gradient-to-b from-white via-white to-slate-100 dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 border-t border-slate-200 dark:border-slate-900/60 transition-colors duration-300 relative">
        <div className="w-full max-w-4xl relative z-10 flex flex-col md:flex-row gap-12 items-stretch">
          ...
          <div className="flex-1 flex flex-col justify-between text-left gap-6">
            ...
            <div className="flex flex-col gap-4 text-xs text-slate-600 dark:text-slate-400 mt-4 border-t border-slate-200 dark:border-slate-900 pt-6">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shrink-0">
                ...
                <span className="text-slate-700 dark:text-slate-400">Adum, Kumasi & East Legon, Accra, Ghana</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shrink-0">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <span className="text-slate-700 dark:text-slate-400">support@easybiz.com.gh</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shrink-0">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <span className="text-slate-700 dark:text-slate-400">+233 24 123 4567</span>
              </div>
            </div>

            <p className="text-[10px] text-slate-500 dark:text-slate-600 leading-tight">
          ...
          <div className="flex-1 glass-panel rounded-3xl p-6 border-slate-200 dark:border-white/10 shadow-xl text-left">
            {contactSubmitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-16 gap-3">
                <div className="w-12 h-12 rounded-full bg-emerald-100 dark:bg-emerald-950 border border-emerald-300 dark:border-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 text-xl animate-bounce">
                  ✓
                </div>
                <h3 className="text-sm font-bold text-slate-800 dark:text-white">Message Dispatched!</h3>
              ...
              <form onSubmit={handleContactSubmit} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="glass-input rounded-xl px-4 py-2.5 text-xs text-slate-800 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-600 w-full"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    className="glass-input rounded-xl px-4 py-2.5 text-xs text-slate-800 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-600 w-full resize-none"
                  />
                </div>
